...
public class AnnotationProxyMaker {
    ...
    private class ValueVisitor implements Visitor {
        ...
        Object getValue(Attribute var1) {
            ...
            var1.accept(this);
            if (!(this.value instanceof ExceptionProxy)
                    && !AnnotationType.invocationHandlerReturnType(this.returnClass).isInstance(this.value)) {
        ...
        public void visitArray(Array var1) {
            ...
            if (var2.equals(var2.table.names.java_lang_Class)) {
                ...
                for (var6 = 0; var6 < var16; ++var6) {
                    ...
                    Type var8 = var7 instanceof UnresolvedClass ? ((UnresolvedClass) var7).classType
                            : ((com.sun.tools.javac.code.Attribute.Class) var7).classType;
                    var14.append(var8);
                }
