...
public class Block extends UnlockableContent implements Senseable {
    ...
    /**
     * Flag for determining whether this block outputs liquid somewhere; used for
     * connections.
     */
    public boolean outputsLiquid = false;
    /**
     * Used by certain power blocks (nodes) to flag as non-consuming of power. True
     * by default, even if this block has no power.
     */
    ...
    /**
     * If true, all item capacities of this block are separate instead of pooled as
     * one number.
     */
    ...
    /**
     * higher numbers increase liquid output speed; TODO remove and replace with
     * better liquids system
     */
    ...
    /**
     * if true, this block does not accept input from the sides (used for armored
     * conveyors)
     */
    ...
    /**
     * if true, this block acts a duct and will connect to armored ducts from the
     * side.
     */
    ...
    /**
     * if rotate = false and this is true, rotation will be locked at 0 when placing
     ...
     * Does not change behavior for non-environmental blocks, but still updates
     * clipSize.
     */
    ...
    public boolean environmentBuildable() {
        return (state.rules.hiddenBuildItems.isEmpty()
                || !Structs.contains(requirements, i -> state.rules.hiddenBuildItems.contains(i.item)));
    }
    ...
    public void init() {
        ...
        buildCost *= buildCostMultiplier * 5f;
