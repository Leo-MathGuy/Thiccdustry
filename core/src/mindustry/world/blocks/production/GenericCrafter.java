...
public class GenericCrafter extends Block {
    ...
    /**
     * Liquid output directions, specified in the same order as outputLiquids. Use
     * -1 to dump in every direction. Rotations are relative to block.
     */
    public int[] liquidOutputDirections = { -1 };

    /**
     * if true, crafters with multiple liquid outputs will dump excess when there's
     * still space for at least one liquid type
     */
