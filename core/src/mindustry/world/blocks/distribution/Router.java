    ...
    public class RouterBuild extends Building implements ControlBlock {
        ...
        public void updateTile() {
            ...
            if (lastItem != null) {
                ...
                if (target != null
                        && (time >= 1f || !(target.block instanceof Router || target.block.instantTransfer))) {
        ...
        public Building getTileTarget(Item item, Tile from, boolean set) {
            ...
            for (int i = 0; i < proximity.size; i++) {
                ...
                if (set)
                    rotation = ((byte) ((rotation + 1) % proximity.size));
                if (other.tile == from && from.block() == Blocks.overflowGate)
                    continue;
