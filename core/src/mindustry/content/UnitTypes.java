...
public class UnitTypes {
    ...
    // naval
    public static @EntityDef({ Unitc.class, WaterMovec.class }) UnitType risso, minke, bryde, sei, omura, retusa,
            oxynoe, cyerce, aegires, navanax;

    // special block unit type
    public static @EntityDef({ Unitc.class, BlockUnitc.class }) UnitType block;

    // special building tethered (has payload capability, because it's necessary
    // sometimes)
                ...
                weapons.add(new Weapon() {
                    {
                        ...
                        bullet = new DaggerBulletType(5f, 8, "dagger-bullet") {
                            {
                                width = 3f;
                                height = 12f;
                                lifetime = 30f;
                        ...
                        bullet = new ContinuousLaserBulletType() {
                            {
                                ...
                                colors = new Color[] { Pal.heal.cpy().a(.2f), Pal.heal.cpy().a(.5f),
                                        Pal.heal.cpy().mul(1.2f), Color.white };
                            }
                        };
                                ...
                                bullet = new LaserBulletType() {
                                    {
                                        ...
                                        colors = new Color[] { Color.valueOf("ec7458aa"), Color.valueOf("ff9c5a"),
                                                Color.white };
                                    }
                                };
                            }
        ...
        omura = new UnitType("omura") {
            {
                ...
                abilities.add(new UnitSpawnAbility(flare, spawnTime, 19.25f, -31.75f),
                        new UnitSpawnAbility(flare, spawnTime, -19.25f, -31.75f));
                        ...
                        bullet = new EmpBulletType() {
                            {
                                ...
                                hitEffect = new Effect(50f, 100f, e -> {
                                    ...
                                    for (int i = 0; i < points; i++) {
                                        ...
                                        Drawf.tri(e.x + Angles.trnsx(angle, rad), e.y + Angles.trnsy(angle, rad), 6f,
                                                50f * e.fout(), angle/* + s*180f */);
                                        // }
                                    }
                        ...
                        bullet = new RailBulletType() {
                            {
                                ...
                                lineEffect = new Effect(20f, e -> {
                                    ...
                                    for (int i = 0; i < 7; i++) {
                                        ...
                                        Lines.lineAngleCenter(e.x + Fx.v.x, e.y + Fx.v.y, e.rotation + e.finpow(),
                                                e.foutpowdown() * 20f * Fx.rand.random(0.5f, 1f) + 0.3f);
                                    }
        ...
        conquer = new TankUnitType("conquer") {
            {
                ...
                treadRects = new Rect[] { new Rect(27 - xo, 152 - yo, 56, 73), new Rect(24 - xo, 51 - 9 - yo, 29, 17),
                ...
                weapons.add(new Weapon("conquer-weapon") {
                    {
                        ...
                        for (int i = 1; i <= 3; i++) {
                            ...
                            parts.add(new RegionPart("-blade") {
                                {
                                    progress = PartProgress.warmup.delay((3 - fi) * 0.3f).blend(PartProgress.reload,
                                            0.3f);
                            ...
                            parts.add(new RegionPart("-blade") {
                                {
                                    ...
                                    moves.add(
                                            new PartMove(PartProgress.reload.inv().mul(1.8f).inv().curve(fi / 5f, 0.2f),
                                                    0f, 0f, 36f));
                                }
                            });
                        }
